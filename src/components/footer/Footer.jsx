    ...
    <footer className="footer">
            ...
            <Col lg="4" md="4" sm="6">
              <div className="logo">
                ...
                <p>
                  ...
                  tempore velit nihil dolores repudiandae, assumenda architecto eaque
                  consequatur, eius soluta quas accusamus iure eos consectetur nisi
                  exercitationem dolorem. Beatae!
                </p>
              </div>
            </Col>
      ...
      <div className="footer__bottom">
        <Container>
          <Row>
            <Col lg="12">
              <p>copyright 2023, developed by Sepideh. All rights reserved</p>
            </Col>
          </Row>
        </Container>
      </div>
